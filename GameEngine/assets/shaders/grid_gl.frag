...
void main()
{
    ...
    vec3 cameraPosition = inverse(uView)[3].xyz;
    float distanceFade = 1.0 -
        smoothstep(10.0, 100.0, distance(cameraPosition, worldPosition));
    ...
    // convert OpenGL normalized depth from -1..1 to the depth buffer range
